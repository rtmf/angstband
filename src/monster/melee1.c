...
{
	"insults you!",
	"insults your boyfriend!",
	"gives you the finger.",
	"spreads rumors about your sexuality.",
	"grabs your ass!",
	"dances around you!",
	"questions your ancestry.",
	"bans you from his forum!"
};
...
{
	"begs for donations.",
	"tells you he needs another server.",
	"asks 'Can I buy a commission?' ",
	"says 'Did you hack my servers?' ",
	"asks 'Do you want to buy a commission?' ",
	"seems sad about everything.",
	"asks if you would like to donate.",
	"mumbles something about Anonymous."
};
